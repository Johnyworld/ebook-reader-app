...
var _viewerH = (_viewerRect && _viewerRect.height > 0) ? _viewerRect.height : (window.innerHeight - (_config.paddingVertical * 2 + 16));
...
window.addEventListener('resize', function() {
    ...
    _epub.rendition.resize(window.innerWidth - s.paddingHorizontal * 2, window.innerHeight - s.paddingVertical * 2 - 16);
